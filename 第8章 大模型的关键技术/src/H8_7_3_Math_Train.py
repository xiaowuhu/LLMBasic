...
def load_data(split):
    path = os.path.join("../data/GSM8K_math", f"{split}.jsonl")
    ds = []
...
if __name__=="__main__":
    ...
    test_dataset = GSMDataset(tokenizer, ds_test)
    ...
    sft_model(model, train_loader, test_loader, device, output_dir)
