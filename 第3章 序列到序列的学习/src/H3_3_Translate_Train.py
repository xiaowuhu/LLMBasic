...
if __name__=="__main__":
    ...
    num_epochs, batch_size, lr = 40, 32, 0.001
    ...
    all_loss = train_seq2seq(encoder, decoder, train_dataloader, None, 
          loss_function, 100, # checkpoint
          encoder_optimizer, decoder_optimizer,
          num_epochs, device, )
          #save_model_names=("Translate_Encoder.pth", "Translate_Decoder.pth"))
