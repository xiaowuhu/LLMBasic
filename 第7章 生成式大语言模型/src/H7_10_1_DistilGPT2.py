...
if __name__ == '__main__':
    ...
    print(f"参数数量:{model.num_parameters()} M")
    ...
    text = text_generator("事情本来是这样的：", do_sample=True, truncation=True, max_length=64)
    print(text)
    text = text_generator("事情本来是这样的：", do_sample=True, truncation=True, max_length=128)
    print(text)
    text = text_generator("事情本来是这样的：", do_sample=True, truncation=True, max_length=256)
    print(text)
    #main()
