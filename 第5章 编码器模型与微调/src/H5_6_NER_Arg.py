...
train_file = '../data/china-people-daily-ner/train.txt'
valid_file = '../data/china-people-daily-ner/valid.txt'
test_file = '../data/china-people-daily-ner/test.txt'

def parse_args():
    parser = argparse.ArgumentParser()

    # Required parameters
    parser.add_argument("--output_dir", default='../model/ch20/6/', type=str,
