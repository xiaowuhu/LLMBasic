...
train_file = '../data/cmrc/train.json'
valid_file = '../data/cmrc/valid.json'
test_file = '../data/cmrc/test.json'

def parse_args():
    parser = argparse.ArgumentParser()

    # Required parameters
    parser.add_argument("--output_dir", default="../model/ch20/7/", type=str, 
        help="The output directory where the model checkpoints and predictions will be written.",
    )
    parser.add_argument("--train_file", default=train_file, type=str, help="The input training file.")
    parser.add_argument("--valid_file", default=valid_file, type=str, help="The input evaluation file.")
    ...
    # Other parameters
    parser.add_argument("--stride", default=128, type=int, help="The number of overlap tokens between adjacent chunks.")
    parser.add_argument("--n_best", default=20, type=int, help="Keep the top n_best tokens with the highest logits.")
