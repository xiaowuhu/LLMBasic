...
def main():
    ...
    parser.add_argument('--length', default=128, type=int, required=False, help='最大生成长度')
    ...
    parser.add_argument('--model_path', default='../model/ch6/poetry/final_model/', type=str, required=False, help='模型路径')
    # 完全随机 default = '[BOS]五言律诗', '[BOS]五言绝句'，'[BOS]七言律诗', '[BOS]七言绝句'
    # 指定藏头 default = '[BOS]五言绝句[SEP]
    parser.add_argument('--prefix', default='[BOS]五言绝句', type=str, required=False, help='')
    ...
    file = "../model/ch6/poetry/bpe-poetry-7000.json"
