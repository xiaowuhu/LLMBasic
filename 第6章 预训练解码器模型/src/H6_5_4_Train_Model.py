...
from H6_5_3_Data_Loader import load_train_data
...
def main():
    ...
    parser.add_argument('--tokenized_data_path', default='../model/ch21/bpe-couplet-10000.json', type=str, required=False, help='tokenized语料存放位置')
    ...
    parser.add_argument('--output_dir', default='../model/ch21/couplet/', type=str, required=False, help='模型输出路径')
